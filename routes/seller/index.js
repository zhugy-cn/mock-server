...
router.get('/test', delayResponse(500), function (ctx, next) {
  setTimeout(() => {
    ctx.body = '请求成功';
  })
})
...
router.post('/payAccount/getAcountMoneyByShopAdminId', delayResponse(200), (ctx, next) => {
...
// 订单列表
router.post('/order/getOrderByShopIdList', delayResponse(100), function (ctx, next) {
...
// 成员列表
router.post('/merchantServerController/getMemberInfoList', delayResponse(150), function (ctx, next) {
...
// 选择角色
router.post('/merchantServerController/getPlatformOpenRolesList', function (ctx, next) {
  ctx.success(data.member.list)
})

// 选择店铺
router.post('/merchantServerController/getManagerShopList', function (ctx, next) {
...
// 团购商品
router.post('/product/getProductPageListByShopId', delayResponse(150), function (ctx, next) {
...
// 流水
router.post('/tradeDetail/queryTradeDetail', delayResponse(150), function (ctx, next) {
  ctx.success(data.report);
})
router.post('/withdraw/queryWithdrawCash', delayResponse(150), function (ctx, next) {
